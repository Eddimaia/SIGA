...
namespace SIGA.API.Migrations
{
    ...
    [Migration("20231114004230_v1.1.1.1")]
    partial class v1111
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SIGA.Lib.Models.EmpresaVPN", b =>
                {
                    b.Property<short>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("SIGA.Lib.Models.Funcionario", b =>
                {
                    ...
                    b.HasIndex(new[] { "Login" }, "IX_Funcionario_Login")
                        .IsUnique();
            ...
            modelBuilder.Entity("SIGA.Lib.Models.TipoAcesso", b =>
                {
                    b.Property<byte>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TINYINT");
            ...
            modelBuilder.Entity("SIGA.Lib.Models.TipoAutenticacaoAcesso", b =>
                {
                    b.Property<byte>("Id")
                        .HasColumnType("tinyint");
            ...
            modelBuilder.Entity("SIGA.Lib.Models.Acesso", b =>
                {
                    ...
                    b.HasOne("SIGA.Lib.Models.TipoAcesso", "TipoAcesso")
                        .WithMany("Acessos")
                        .HasForeignKey("TipoAcessoId")
                        .HasConstraintName("FK_Acesso_TipoAcessoId");

                    b.HasOne("SIGA.Lib.Models.TipoAutenticacaoAcesso", "TipoAutenticacaoAcesso")
                        .WithMany("Acessos")
            ...
            modelBuilder.Entity("SIGA.Lib.Models.VPN", b =>
                {
                    ...
                    b.HasOne("SIGA.Lib.Models.EmpresaVPN", "EmpresaVPN")
                        .WithMany("VPNs")
